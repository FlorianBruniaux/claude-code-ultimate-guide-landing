...
const pageEntries: SearchEntry[] = [
  ...
  {
    id: 'page-guide-changelog',
    title: 'Guide Changelog: What Changed in the Guide',
    keywords: 'guide changelog updates new pages corrections ebooks cheat sheets machine readable mcp',
    category: 'Pages',
    url: '/changelog/',
    source: 'landing',
  },
  {
    ...
    keywords: 'claude code cli releases versions environment variables config flags breaking changes anthropic',
    category: 'Pages',
    url: '/releases/',
    source: 'landing',
  },
...
const guideSpotlightEntries: SearchEntry[] = [
  ...
  {
    id: 'guide-dynamic-workflows',
    title: 'Dynamic Workflows: JS-Orchestrated Multi-Agent Pipelines',
    keywords: 'dynamic workflows ultracode workflow builder javascript orchestration multi-agent parallel pipeline phase agent primitives schema structured output resume adversarial verification loop until dry judge panel benchmark 78k tokens 8.4 seconds',
  ...
  {
    id: 'guide-workflow-patterns',
    title: 'Workflow Patterns: Adversarial Verify, Loop-Until-Dry, Judge Panels, Multi-Modal Sweep',
    keywords: 'adversarial verification loop until dry judge panel multi modal sweep plan execute review workflow patterns false positives refute findings budget guard',
    category: 'Guide > Workflows',
