...
const homepageEntries: SearchEntry[] = [
  ...
  },
  {
    ...
    title: 'Methodologies',
    keywords: 'methodologies approaches patterns tdd plan mode thinking ultrathink',
    category: 'Homepage',
    url: '/#methodologies',
    source: 'landing',
  },
  {
    ...
    keywords: 'getting started onboarding setup first steps beginners install',
    category: 'Homepage',
    url: '/#onboarding',
    source: 'landing',
  },
  {
    id: 'home-token',
    title: 'Token Optimization',
    keywords: 'token optimization cost reduction context window efficiency rtk',
    category: 'Homepage',
