 ...
 * Source of truth for indexed templates (277 total; auto-generated 2026-09-26)
...
export const EXAMPLES = {
    agents: {
        ...
        files: [
            ...
            { name: "analytics-with-eval/analytics-agent.md", path: "agents/analytics-with-eval/analytics-agent.md", description: "Analytics agent with LLM-as-a-judge evaluation loop for output quality" },
            { name: "analytics-with-eval/eval/report-template.md", path: "agents/analytics-with-eval/eval/report-template.md", description: "Monthly evaluation template for scoring analytics agent performance and accuracy" },
            ...
            { name: "cyber-defense/anomaly-detector.md", path: "agents/cyber-defense/anomaly-detector.md", description: "Detect security log anomalies using statistical baselines" },
            { name: "cyber-defense/log-ingestor.md", path: "agents/cyber-defense/log-ingestor.md", description: "Ingest and normalize logs from multiple sources for threat analysis" },
            { name: "cyber-defense/risk-classifier.md", path: "agents/cyber-defense/risk-classifier.md", description: "Classify security events by severity using CVSS framework" },
            { name: "cyber-defense/threat-reporter.md", path: "agents/cyber-defense/threat-reporter.md", description: "Generate structured threat reports from classified security events" },
    ...
    skills: {
        ...
        files: [
            ...
            { name: "design-patterns/", path: "skills/design-patterns/SKILL.md", description: "Detect and analyze GoF design patterns" },
            { name: "voice-refine/", path: "skills/voice-refine/SKILL.md", description: "Writing voice refinement with before/after examples" },
            { name: "rtk-optimizer/", path: "skills/rtk-optimizer/SKILL.md", description: "RTK token optimization analysis" },
            { name: "audit-agents-skills/", path: "skills/audit-agents-skills/SKILL.md", description: "Quality audit for agents, skills, and commands" },
            { name: "skill-creator/", path: "skills/skill-creator/SKILL.md", description: "Create new skills with proper structure and best practices" },
            { name: "landing-page-generator/", path: "skills/landing-page-generator/SKILL.md", description: "Generate deploy-ready landing pages from any repository" },
            { name: "ccboard/", path: "skills/ccboard/SKILL.md", description: "TUI/Web dashboard for Claude Code session monitoring" },
            { name: "guide-recap/", path: "skills/guide-recap/SKILL.md", description: "Transform CHANGELOG entries into social content" },
            { name: "release-notes-generator/", path: "skills/release-notes-generator/SKILL.md", description: "Generate release notes in 3 formats from git commits" },
            { name: "pr-triage/", path: "skills/pr-triage/SKILL.md", description: "4-phase PR backlog management with worktree setup" },
            ...
            { name: "best-of-n/", path: "skills/best-of-n/SKILL.md", description: "Generate bounded independent candidates, score them against a frozen rubric, and verify the selected result with a proof" },
            ...
            { name: "learning-path/", path: "skills/learning-path/SKILL.md", description: "Run the local Claude Code learning path, record evidence, and schedule evidence-based reviews." },
    ...
    "hooks-bash": {
        ...
        files: [
            ...
            { name: "test-hooks.sh", path: "hooks/bash/test-hooks.sh", description: "set -euo pipefail" },
            ...
            { name: "verification-gate.sh", path: "hooks/bash/verification-gate.sh", description: "set -euo pipefail" }
        ]
    },
    "hooks-powershell": {
        icon: "\u{1FA9F}",
    ...
    "claude-md": {
        ...
        files: [
            { name: "TESTING.md", path: "claude-md/TESTING.md", description: "Copy this file into a work item before testing a change, an agent workflow, or a Best-of-N selection. Fill in fields wit" },
            { name: "agent-progress.md", path: "claude-md/agent-progress.md", description: "<!--" },
    ...
    scripts: {
        ...
        files: [
            ...
            { name: "supply-chain-triage.py", path: "scripts/supply-chain-triage.py", description: "Triage a workstation after an npm supply chain incident" },
    ...
    templates: {
        ...
        files: [
            { name: "ai-assisted-contribution.md", path: "templates/ai-assisted-contribution.md", description: "Record reproduction, verification evidence, author explanation and maintainer follow-up" },
    ...
    workflows: {
        ...
        files: [
            { name: "bounded-loop-contract.md", path: "workflows/bounded-loop-contract.md", description: "Reference contract for a bounded agent loop with a separate verifier interface, evidence, and escalation" },
            ...
            { name: "review-admission.md", path: "workflows/review-admission.md", description: "Define shared review capacity, pause and resume rules, and a tabletop exercise" }
        ]
    },
    plugins: {
        icon: "\u{1F9E9}",
        ...
        files: [
            ...
            { name: "code-quality/plugin.json", path: "plugins/code-quality/plugin.json", description: "{" },
            { name: "devops-pipeline/plugin.json", path: "plugins/devops-pipeline/plugin.json", description: "{" },
            { name: "pr-workflow/plugin.json", path: "plugins/pr-workflow/plugin.json", description: "{" },
            { name: "release-automation/plugin.json", path: "plugins/release-automation/plugin.json", description: "{" },
            { name: "se-cove.md", path: "plugins/se-cove.md", description: "Chain-of-Verification for independent code review (Meta AI, ACL 2024)" },
            { name: "security-suite/plugin.json", path: "plugins/security-suite/plugin.json", description: "{" }
        ]
    },
    integrations: {
        icon: "\u{1F50C}",
