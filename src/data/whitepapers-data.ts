...
export const WHITEPAPERS: Whitepaper[] = [
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `01-prompts-efficaces.fr.${V}.952d7405e6ac.pdf`,
    hashedFileEn: `01-effective-prompts.en.${V}.0906826e5283.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `02-personnalisation.fr.${V}.7a16aea8bed8.pdf`,
    hashedFileEn: `02-customization.en.${V}.400ac67ad412.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `03-securite.fr.${V}.8b2be84849f1.pdf`,
    hashedFileEn: `03-security.en.${V}.d5d9e322e8f8.pdf`,
    slugFr: '03-securite',
    slugEn: '03-security',
  },
  {
  ...
  },
  {
    ...
    badge: 'Popular',
    formats: ['pdf', 'epub'],
    hashedFileFr: `07-guide-reference.fr.${V}.73dde54c5a23.pdf`,
    hashedFileEn: `07-reference-guide.en.${V}.38bd51186c9e.pdf`,
  ...
  },
  {
    ...
    badge: 'New',
    formats: ['pdf'],
    hashedFileFr: `11-team-metrics.fr.${V}.8ed716d2966e.pdf`,
    hashedFileEn: `11-team-metrics.en.${V}.8ff88f1610e5.pdf`,
