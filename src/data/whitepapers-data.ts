...
export const WHITEPAPERS: Whitepaper[] = [
  {
    ...
    badge: 'Open',
    formats: ['pdf', 'epub'],
    hashedFileFr: `00-introduction-serie.fr.${V}.acbe9f5c97aa.pdf`,
    hashedFileEn: `00-series-introduction.en.${V}.cf9ada13e7b9.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `01-prompts-efficaces.fr.${V}.82e9e23c0fcf.pdf`,
    hashedFileEn: `01-effective-prompts.en.${V}.b48f05867411.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `02-personnalisation.fr.${V}.a771c8e6c7df.pdf`,
    hashedFileEn: `02-customization.en.${V}.100e0de74343.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `03-securite.fr.${V}.714931e8907b.pdf`,
    hashedFileEn: `03-security.en.${V}.ddd86f79332f.pdf`,
    slugFr: '03-securite',
    slugEn: '03-security',
  },
  {
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `05-equipe.fr.${V}.30fec36698cb.pdf`,
    hashedFileEn: `05-team.en.${V}.5fa5cb7f7539.pdf`,
    slugFr: '05-equipe',
    slugEn: '05-team',
  },
  {
  ...
  },
  {
    ...
    badge: 'Popular',
    formats: ['pdf', 'epub'],
    hashedFileFr: `07-guide-reference.fr.${V}.cbd0497c527c.pdf`,
    hashedFileEn: `07-reference-guide.en.${V}.8b90b3d6038f.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `08-agent-teams.fr.${V}.159b7f7452bc.pdf`,
    hashedFileEn: `08-agent-teams.en.${V}.9d70b12b1180.pdf`,
