...
export interface Whitepaper {
  ...
  tags: string[]
  gated: boolean       // false = free download, true = email required
  badge?: string
  formats: ('pdf' | 'epub')[]
...
export const WHITEPAPERS: Whitepaper[] = [
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `09-apprendre-avec-ia.fr.${V}.71fc23f73cf0.pdf`,
    hashedFileEn: `09-learning-with-ai.en.${V}.e8b9d58ed1a5.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `10-budget-ia.fr.${V}.41c3bf716b9f.pdf`,
    hashedFileEn: `10-ai-budget.en.${V}.29b5a510184b.pdf`,
    slugFr: '10-budget-ia',
    slugEn: '10-ai-budget',
  },
]
