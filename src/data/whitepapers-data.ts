...
export const WHITEPAPERS: Whitepaper[] = [
  {
    ...
    badge: 'Open',
    formats: ['pdf', 'epub'],
    hashedFileFr: `00-introduction-serie.fr.${V}.6ea4bb6157d7.pdf`,
    hashedFileEn: `00-series-introduction.en.${V}.cce116d244c4.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `01-prompts-efficaces.fr.${V}.2ab57f5009e3.pdf`,
    hashedFileEn: `01-effective-prompts.en.${V}.7cde72d1a67d.pdf`,
