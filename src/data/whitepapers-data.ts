...
export const WHITEPAPERS: Whitepaper[] = [
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `02-personnalisation.fr.v3.43.0.de43cd2cfbb0.pdf`,
    hashedFileEn: `02-customization.en.v3.43.0.4558e59fd104.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `04-architecture.fr.v3.43.0.dfba76f8cbad.pdf`,
    hashedFileEn: `04-architecture.en.v3.43.0.814f0d9e01dd.pdf`,
  ...
  },
  {
    ...
    badge: 'Popular',
    formats: ['pdf', 'epub'],
    hashedFileFr: `07-guide-reference.fr.v3.43.0.0df0a5da90f3.pdf`,
    hashedFileEn: `07-reference-guide.en.v3.43.0.1fa756364be0.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `08-agent-teams.fr.v3.43.0.a4c910672f5e.pdf`,
    hashedFileEn: `08-agent-teams.en.v3.43.0.a8dddf2502b3.pdf`,
