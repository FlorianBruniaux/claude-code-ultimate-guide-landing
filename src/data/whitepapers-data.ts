...
export const WHITEPAPERS: Whitepaper[] = [
  {
    ...
    badge: 'Open',
    formats: ['pdf', 'epub'],
    hashedFileFr: `00-introduction-serie.fr.${V}.e9b77a0f43e0.pdf`,
    hashedFileEn: `00-series-introduction.en.${V}.882128df6864.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `01-prompts-efficaces.fr.${V}.329c77982230.pdf`,
    hashedFileEn: `01-effective-prompts.en.${V}.f63e77d23bca.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `02-personnalisation.fr.${V}.2ec5c41fdde8.pdf`,
    hashedFileEn: `02-customization.en.${V}.58ba64177d0e.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `04-architecture.fr.${V}.62cba7f9a793.pdf`,
    hashedFileEn: `04-architecture.en.${V}.fa71b68cdc51.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `05-equipe.fr.${V}.8c0c503895c3.pdf`,
    hashedFileEn: `05-team.en.${V}.16c1170ef64d.pdf`,
    slugFr: '05-equipe',
    slugEn: '05-team',
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `06-privacy.fr.${V}.da384bdb991e.pdf`,
    hashedFileEn: `06-privacy.en.${V}.e5ca1b3e4038.pdf`,
    slugFr: '06-privacy',
    slugEn: '06-privacy',
  },
  {
    ...
    badge: 'Popular',
    formats: ['pdf', 'epub'],
    hashedFileFr: `07-guide-reference.fr.${V}.754e58c6543f.pdf`,
    hashedFileEn: `07-reference-guide.en.${V}.cb114abd83a4.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `08-agent-teams.fr.${V}.666b6a7a79a7.pdf`,
    hashedFileEn: `08-agent-teams.en.${V}.0ef224b789fa.pdf`,
  ...
  },
  {
    ...
    gated: true,
    formats: ['pdf', 'epub'],
    hashedFileFr: `09-apprendre-avec-ia.fr.${V}.0550398d9da6.pdf`,
    hashedFileEn: `09-learning-with-ai.en.${V}.79ed4d3cb3f2.pdf`,
  ...
  },
  {
    ...
    badge: 'New',
    formats: ['pdf'],
    hashedFileFr: `11-team-metrics.fr.${V}.d01c97e98905.pdf`,
    hashedFileEn: `11-team-metrics.en.${V}.db8dfde4b279.pdf`,
