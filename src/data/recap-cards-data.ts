...
export const RECAP_SERIES: RecapCardSeries[] = [
  {
    ...
    cardCount: 22,
    released: true,
    hashedZipFr: 'recap-cards-technique.fr.v1.0.0.ecb71a46ede5.zip',
    hashedZipEn: 'recap-cards-technique.en.v1.0.0.0518aa959beb.zip',
  },
  {
    id: 'M',
    name: 'Methodology',
    ...
    cardCount: 22,
    released: true,
    hashedZipFr: 'recap-cards-methodologie.fr.v1.0.0.4b84b5351a3c.zip',
    hashedZipEn: 'recap-cards-methodologie.en.v1.0.0.f82d0b3f9c9f.zip',
  },
  {
    id: 'C',
    name: 'Design',
    ...
    cardCount: 13,
    released: true,
    hashedZipFr: 'recap-cards-conception.fr.v1.0.0.ead352009010.zip',
    hashedZipEn: 'recap-cards-conception.en.v1.0.0.36d8fece10c5.zip',
  },
]
...
export const CARD_HASHES_FR: Record<string, string> = {
  ...
  'c03-xml-prompting-anchors': 'c03-xml-prompting-anchors.fr.v1.0.0.a6473b0fe8eb.pdf',
  ...
  'c06-configuration-decision-guide': 'c06-configuration-decision-guide.fr.v1.0.0.357dab3be5d6.pdf',
  ...
  'm02-context-management': '04-context-management.fr.v1.0.0.9c19ef0f4cf3.pdf',
  ...
  'm05-plan-mode': 'm05-plan-mode.fr.v1.0.0.bdd69fe0e359.pdf',
  ...
  'm11-hooks-evenements-systeme': 'm11-hooks-evenements-systeme.fr.v1.0.0.a466c95eeb27.pdf',
  ...
  // ── Technique (T) ───────────────────────────────────────────────────────────
  't01-commandes-essentielles': '01-commandes-essentielles.fr.v1.0.0.956a31393dc8.pdf',
  't02-mode-non-interactif': 't02-mode-non-interactif.fr.v1.0.0.89847a03ef89.pdf',
  't03-permission-modes': '03-permission-modes.fr.v1.0.0.e290011c6222.pdf',
  't04-permissions-glob-patterns': 't04-permissions-glob-patterns.fr.v1.0.0.6e1517fd6036.pdf',
  't05-hierarchie-configuration': '06-hierarchie-configuration.fr.v1.0.0.091125276f31.pdf',
  't06-settings-json': 't06-settings-json.fr.v1.0.0.d857d3593501.pdf',
  ...
  't09-workspace-hygiene': 't09-workspace-hygiene.fr.v1.0.0.a9ad04514fb1.pdf',
  't10-config-multi-machine': 't10-config-multi-machine.fr.v1.0.0.a91474c04f2e.pdf',
...
export const CARD_HASHES_EN: Record<string, string> = {
  ...
  'c03-xml-prompting-anchors': 'c03-xml-prompting-anchors.en.v1.0.0.a79e83f863b7.pdf',
  ...
  'c06-configuration-decision-guide': 'c06-configuration-decision-guide.en.v1.0.0.03d2db44bd88.pdf',
  'c07-conventions-equipe-scale': 'c07-conventions-equipe-scale.en.v1.0.0.57ef170e9883.pdf',
  'c08-surface-attaque-menaces': 'c08-surface-attaque-menaces.en.v1.0.0.ecb2f1cb062a.pdf',
  ...
  'c13-erreurs-courantes': 'c13-erreurs-courantes.en.v1.0.0.bff3e1092ebf.pdf',
  // ── Methodology (M) ─────────────────────────────────────────────────────────
  'm01-workflow-quotidien': 'm01-workflow-quotidien.en.v1.0.0.31f32d824b67.pdf',
  'm02-context-management': 'm02-context-management.en.v1.0.0.2c4104700368.pdf',
  ...
  'm05-plan-mode': 'm05-plan-mode.en.v1.0.0.b734bebdded0.pdf',
  'm06-task-management-system': 'm06-task-management-system.en.v1.0.0.6b00020f26bf.pdf',
  'm07-todowrite-vs-tasks-api': 'm07-todowrite-vs-tasks-api.en.v1.0.0.fc2634864af8.pdf',
  ...
  'm11-hooks-evenements-systeme': 'm11-hooks-evenements-systeme.en.v1.0.0.43c274927504.pdf',
  ...
  // ── Technical (T) ───────────────────────────────────────────────────────────
  't01-commandes-essentielles': 't01-commandes-essentielles.en.v1.0.0.d3cf4a351064.pdf',
  't02-mode-non-interactif': 't02-mode-non-interactif.en.v1.0.0.872bc51bb10b.pdf',
  't03-permission-modes': 't03-permission-modes.en.v1.0.0.504d374ae43d.pdf',
  't04-permissions-glob-patterns': 't04-permissions-glob-patterns.en.v1.0.0.c84271ca96cb.pdf',
  't05-hierarchie-configuration': 't05-hierarchie-configuration.en.v1.0.0.9c5dae3eb748.pdf',
  't06-settings-json': 't06-settings-json.en.v1.0.0.05fe3d999cca.pdf',
  ...
  't09-workspace-hygiene': 't09-workspace-hygiene.en.v1.0.0.8bac9616e970.pdf',
  't10-config-multi-machine': 't10-config-multi-machine.en.v1.0.0.ba454c04811c.pdf',
  ...
  't16-sandbox-natif-architecture': 't16-sandbox-natif-architecture.en.v1.0.0.a635f72e65b6.pdf',
