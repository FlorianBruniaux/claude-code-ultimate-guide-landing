...
export const GUIDE_ENTRIES: GuideSearchEntry[] = [
  ...
  {
    "id": "guide-agentic-software-factories-post-merge",
    "title": "Agentic Software Factories Post Merge",
